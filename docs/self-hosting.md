...
Build the Docker image by cloning [the repo](https://github.com/Phineas/lanyard) and running:
...
You also need to create a Discord bot and use its token above. Create a bot here: https://discord.com/developers/applications
...
<small>Adapted from [lanyard.eggsy.xyz](https://lanyard.eggsy.xyz/api/self-hosting).</small>
